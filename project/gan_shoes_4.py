...
def train_step(images):
    ...
    # compute gradients by using tape, optimize the networks
...
def train_forever(dataset):
    ...
    try:
        while True:
            ...
            print('epoch {: 3} took {:.4f} sec, with {:.4f} G_loss and {:.4f} D_loss'.format(epoch + 1, time.time() - start, gen_loss, disc_loss))
            epoch += 1
